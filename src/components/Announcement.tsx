					...
					>
						{
							...
							shaman
								...
								:
							oneHandedWeapons
								? "Одноручное оружие, искусство смертоносной грации и невероятной скорости! Идеальный выбор тех, кто ценит скорость выше грубой силы. Когда каждый взмах клинка рождает вихрь молниеносных ударов, сметающий врагов. Неважно, что перед тобой полчища Плети или легионеры Пылающего Легиона скорость твоего клинка решает всё. Одноручник доказывает, что один искусный воин стоит целой армии!"
								:
							twoHandedWeapons
